	...
	usePropertyMenu(
		[
			...
			},
			{
				...
				<path fill-rule="evenodd" clip-rule="evenodd" d="M17.3536 20.3533L17 20.7069L16.6464 20.3533L13.6464 17.3533L14.3536 16.6462L16.5 18.7926V10.9998H17.5V18.7926L19.6464 16.6462L20.3536 17.3533L17.3536 20.3533ZM11 20.9997H10V22.9998V23.9997V23.9998H24V23.9997V22.9998V20.9997H23V22.9998H11V20.9997Z" fill="white"/>
				</svg>`
			},
			{
				tooltip: 'Settings',
				...
				itemType: 'action',
				icon: `<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path fill-rule="evenodd" clip-rule="evenodd" d="M14 18.05V11H15V18.05C16.1411 18.2816 17 19.2905 17 20.5C17 21.7095 16.1411 22.7184 15 22.95V25H14V22.95C12.8589 22.7184 12 21.7095 12 20.5C12 19.2905 12.8589 18.2816 14 18.05ZM16 20.5C16 21.3284 15.3284 22 14.5 22C13.6716 22 13 21.3284 13 20.5C13 19.6716 13.6716 19 14.5 19C15.3284 19 16 19.6716 16 20.5ZM21 25H22V17.95C23.1411 17.7184 24 16.7095 24 15.5C24 14.2905 23.1411 13.2816 22 13.05V11H21V13.05C19.8589 13.2816 19 14.2905 19 15.5C19 16.7095 19.8589 17.7184 21 17.95V25ZM23 15.5C23 14.6716 22.3284 14 21.5 14C20.6716 14 20 14.6716 20 15.5C20 16.3284 20.6716 17 21.5 17C22.3284 17 23 16.3284 23 15.5Z" fill="white"/>
				</svg>`
			}
		],
